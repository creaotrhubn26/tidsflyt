...
| 26 | E | Elements, Documaster, Visma, KS FIKS, Entra, ID-porten, ev. Intune | Documaster-adapter og direkte BankID/Buypass er implementert; Entra og Maskinporten ligger i integrasjonsarbeidet; BRREG-/PowerOffice-byggeklosser finnes. Elements med avvikende kontrakt er ikke implementert og tilbys som separat, priset opsjon O1. O1 gjenbruker arkivgrensesnitt/outbox, men dekker ett alternativt arkivmål – ikke samtidig dobbelarkivering. FIKS-receiver er stub. | Delvis – stor restanse / Elements O1 | Pris og tidsplan for O1 i Bilag 6; Elements-kontrakt/testtenant ved utøvelse; sandkassebevis for Documaster, Visma Enterprise Plus og full FIKS-portefølje; uttrykkelig ID-porten eller skriftlig akseptert eID-alternativ; Entra; FREG; Intune-avklaring og E2E-avstemming. |
