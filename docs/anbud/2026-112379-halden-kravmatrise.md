...
| 8 | Skal | Interne varsler og sikker melding med eksterne | Ordinær SMTP er sperret for sensitivt innhold. Migrasjon 071/072, API-et og de responsive ansatt-/innbyggerflatene gir kommune-/saksbundet part, eID-only portalidentitet, kryptert toveis dialog, private vedlegg, lesekvittering, tilbakekalling, append-only audit og nøytralt e-postvarsel. Første scope er bekymringsmelding; desktop, mobil, innbyggersvar og avvist tilgang er E2E-testet. | Delvis – operativ førsteflyt | Formell WCAG-test; malwarekarantene; arkiv/retensjon/nøkkelrotasjon; fullmakt/samtykke; utvid til full sak; produksjonsprøv eID og koble SvarUt/SvarInn der Halden krever det. |
