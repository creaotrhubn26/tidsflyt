...
| 20 | Skal | Sentral identitet/SSO og MFA | Direkte BankID og Buypass ID er implementert i `main` for web/mobil og identitetskobling; Entra for ansatte ligger i PR #21; TOTP ligger i G10-grenen. Ingen ID-porten. | Delvis – sterkere eID-grunnlag | Produksjonsbevis for BankID/Buypass; integrer Entra og MFA; avklar Halden-eid/autoriserte ID-porten-løsning for eksterne; livssyklus/SCIM ved behov; test mot kundetenanter. |
