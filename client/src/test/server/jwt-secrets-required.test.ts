...
describe("JWT-hemmeligheter krever eksplisitt konfigurasjon, ingen fallback", () => {
  ...
  it("requireEmailLoginSecret returnerer verdien når satt, uten å falle til JWT_SECRET/SESSION_SECRET", () => {
  ...
  it("requireAuthJwtSecret kaster når AUTH_JWT_SECRET mangler, selv med JWT_SECRET/SESSION_SECRET satt", () => {
    process.env.JWT_SECRET = "should-never-be-used";
