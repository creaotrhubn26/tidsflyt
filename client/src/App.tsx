...
const ImportEmployeesPreview = lazy(() => import("@/pages/import-employees-preview"));
...
const TurnusPage = lazy(() => import("@/pages/turnus"));
...
function Router() {
  ...
  const switchElement = (
    <Switch>
        ...
        <Route path="/turnus">{() => <AuthGuard><TurnusPage /></AuthGuard>}</Route>
