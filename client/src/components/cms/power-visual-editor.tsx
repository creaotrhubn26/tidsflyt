...
const COMPONENT_LIBRARY: ComponentTemplate[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    config: {
      ...
      content: {
        columns: [
          { heading: 'Om Tidum', text: 'Arbeidstidssystem for felt, turnus og norsk dokumentasjonskrav.', email: 'hello@creatorhubn.com' },
        ...
        copyright: '© Tidum. Driftet av Creatorhub AS.',
  ...
  // ═══════════════════════════════════════════
  {
    ...
    config: {
      ...
      content: {
        items: [
          { icon: 'Mail', label: 'E-post', value: 'hello@creatorhubn.com', href: 'mailto:hello@creatorhubn.com' },
