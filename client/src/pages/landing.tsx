      ...
      return (
        <>
          <DialogHeader>
            ...
            <DialogDescription>
              Velg din foretrukne innloggingsmetode
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  Logg inn med Google eller Apple for sikker tilgang.
                </p>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="flex flex-col gap-3 pt-4">
              ...
              <a href="/api/auth/apple" className="w-full">
              ...
              <Button type="button" variant="ghost" onClick={() => setDialogMode('choice')} data-testid="button-back-login">
                Tilbake
              </Button>
            </div>
          </div>
